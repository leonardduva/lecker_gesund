...
class DetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // use split to seperate steps after split('char')
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      _buildFoodPhoto(),
                      SizedBox(height: 32),
                      _buildRecipe(context, ingredientsList, descriptionList)
                    ],
                  ),
                ),
              ),
  ...
  Column _buildRecipe(BuildContext context, List<String> ingredientsList,
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 24),
        Text('Directions', style: Theme.of(context).textTheme.headline6),
        SizedBox(height: 8),
        ...descriptionList.map(
          (item) => Column(
            children: [
  ...
  Padding _buildFavButton(BuildContext context) {
    return Padding(
